...
const statusColumns = [
  { key: 'novo', label: 'Novo', color: 'bg-blue-100 text-blue-800' },
  { key: 'em_validacao', label: 'Em Validação', color: 'bg-yellow-100 text-yellow-800' },
  { key: 'prospeccao', label: 'Prospecção', color: 'bg-purple-100 text-purple-800' },
  { key: 'negociando', label: 'Negociando', color: 'bg-orange-100 text-orange-800' },
  { key: 'finalizado', label: 'Finalizado', color: 'bg-green-100 text-green-800' },
];
...
const Dashboard = () => {
  ...
  const getStatusBadgeColor = (status: string | null) => {
    const column = statusColumns.find(col => col.key === (status || 'novo'));
    ...
    <div className="min-h-screen bg-background p-4">
      <div className="container mx-auto py-8">
        <div className="text-center mb-8">
          <h1 className="text-4xl font-bold mb-4">Dashboard de Leads</h1>
          <p className="text-xl text-muted-foreground">
            Gerencie seus leads por estágio do funil
          </p>
        </div>
                  ...
                  <div>
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div><strong>Status:</strong> 
                        <Badge className={`ml-2 ${getStatusBadgeColor(selectedLead.status)}`}>
